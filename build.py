...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .banners { display: flex; gap: 14px; margin: 4px 0 20px; flex-wrap: wrap; }
...
<div class="wrap">
  ...
  <div class="banners">
    ...
    <a class="banner" href="cheatsheet.html">
      <span class="banner-icon">📋</span>
      <span class="banner-text"><b>Agent Skills Cheat Sheet</b> — what the AI skill packs actually teach, distilled</span>
      <span class="banner-arrow">→</span>
    </a>
  </div>
  <div class="controls">
